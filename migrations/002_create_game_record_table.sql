...
CREATE INDEX IF NOT EXISTS idx_game_record_game_result_type ON game_record(game_result_type); 
CREATE INDEX IF NOT EXISTS idx_game_record_settlement_status ON game_record(settlement_status);
CREATE INDEX IF NOT EXISTS idx_game_record_created_at ON game_record(created_at);